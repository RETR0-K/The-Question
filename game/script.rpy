...
define s = Character(_("Sylvie"), color="#E659EA")
define m = Character(_("Me"), color="#4364F9")
...
label start:
    ...
    "This is a test to see if the ren'y game engine is working properly."

    "Game is going to start from here."
